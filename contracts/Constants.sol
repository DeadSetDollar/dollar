/*
    Copyright 2020 Dead Set Team <deadsetdollar@protonmail.com>
...
library Constants {
    ...
    /* Bootstrapping */
    uint256 private constant BOOTSTRAPPING_PERIOD = 336; // 14 days
    uint256 private constant BOOTSTRAPPING_PRICE = 12e17; // 1.20 DAI

    /* Oracle */
//    address private constant USDC =
//    address(0x6B175474E89094C44Da98b954EedeAC495271d0F); // actually DAI

    address private constant USDC =
    address(0xf80A32A835F79D7787E8a8ee5721D0fEaFd78108); // ropsten DAI
    ...
    uint256 private constant CURRENT_EPOCH_START = 1609459200; // new year new coin
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 25e19; // 250 DED
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 96; // 4 days

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 48; // 2 days

    /* Market */
    uint256 private constant COUPON_EXPIRATION = 6360; // 365 days
