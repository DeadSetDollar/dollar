...
const INITIAL_STAKE_MULTIPLE = new BN(10).pow(new BN(6)); // 100 DED -> 100M DEDS
...
describe('Pool', function () {
  ...
  beforeEach(async function () {
    ...
    this.dollar = await MockToken.new("Dead Set Dollar", "DED", 18, {from: ownerAddress, gas: 8000000});
    ...
    this.pool = await MockPool.new(this.dai.address, {from: ownerAddress, gas: 8000000});
